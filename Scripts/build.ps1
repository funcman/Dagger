#=====================================================================
# build.ps1 - Dagger one-click build script (PowerShell / Windows)
#
# Usage:
...
#
# Outputs (under build\):
#   bin\<Config>\Client.exe          client program
#   bin\<Config>\DBase.dll           base library
#   bin\<Config>\DEngine.dll         engine library
#   lib\<Config>\*.lib               import libraries
#=====================================================================
param(
